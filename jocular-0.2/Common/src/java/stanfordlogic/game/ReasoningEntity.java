...
public class ReasoningEntity
{
    ...
    protected List<GroundFact> getAllAnswers2(ProofContext context, String[] args) {
    	return getAllAnswers(context, args);
    }
    
    protected Iterable<GroundFact> getAllAnswersIterable2(ProofContext context, String[] args) {
    	return getAllAnswersIterable(context, args);
    }
    
    protected GroundFact getAnAnswer2(ProofContext context, String[] args) {
    	return getAnAnswer(context, args);
    }
